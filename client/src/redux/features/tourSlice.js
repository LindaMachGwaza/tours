...
//Create tours and add them to database
...
//Update tour and show a pop up message if successful
...
//allow user to search for tours using tags
...
const tourSlice = createSlice({
  ...
  extraReducers: {
    ...
    //update tour lifecycle. If successful show the updated tour new information
